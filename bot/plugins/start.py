...
async def start(c, m, cb=False):
    ...
    username = 'rahulkhatri137'
    mention = '[Rahul](https://t.me/rahulkhatri137)'
    try:
        owner = await c.get_users(owner_id)
        username = owner.username if owner.username else 'rahulkhatri137'
